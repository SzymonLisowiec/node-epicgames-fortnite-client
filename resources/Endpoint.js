module.exports = Object.freeze({
  ...
  /**
   * LogProfileSys: MCP-Profile: subscribed to notifications topic
   * '/topic/fn/profile/{{account_id}}/fortnite'
   * LogPostmaster: Display: Subscribed to Stomp topic
   * '/topic/fn/twitch/{{account_id}}/fortnite' with id 'mcp-1-nil'
   */
